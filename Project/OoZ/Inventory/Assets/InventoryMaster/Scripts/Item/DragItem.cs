    ...
    public void OnEndDrag(PointerEventData data)
    {
        if (data.button == PointerEventData.InputButton.Left)
        {
            ...
            else
            {
                ...
                //Sprite ItemImage = (Sprite)Instantiate(GetComponent<ItemOnObject>().item.itemIcon);
                //int ItemNum = GetComponent<ItemOnObject>().item.itemValue;
                ...
                //dropItem.GetComponent<SpriteRenderer>().sprite = ItemImage;
                ...
                //dropItem.transform.localPosition = hit.point;

                //inventory.OnUpdateItemList();

                //ItemNum--;
                //itemDatabase.setItemValue(GetComponent<ItemOnObject>().item.itemID, ItemNum);
                ...
                //    {
                //        GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerInventory>().inventory.GetComponent<Inventory>().addItemToInventory(GetComponent<ItemOnObject>().item.itemID, GetComponent<ItemOnObject>().item.itemValue);
                //        Destroy(this.gameObject);
                ...
                dropItem.AddComponent<PickUpItem>();
                dropItem.GetComponent<PickUpItem>().item = this.gameObject.GetComponent<ItemOnObject>().item;
                dropItem.GetComponent<PickUpItem>().item.itemValue = GetComponent<ItemOnObject>().item.itemValue;
                ...
                {
                    dropItem.transform.localPosition = hit.point;
                    itemDatabase.setItemValue(GetComponent<ItemOnObject>().item.itemID, 0);
                }
